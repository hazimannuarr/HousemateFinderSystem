    ...
    if (is_array($row))
    {
      if (password_verify($password, $row['Password']))
      {
        ...
        header("Location:index.php");
                ...
                $resulterrorlevel="<div class='alert alert-danger alert-dismissable'><a href='#'' class='close' data-dismiss='alert' aria-label='close'>&times;</a><strong></strong>Email and password mismatch.</div>" ;
...
?>
 ...
 <!DOCTYPE html>
  <?php include_once 'nav_bar_login.php'; ?>
       ...
       <body>
           <div id="login" style="">
           <h3 class="text-center text-white pt-5" style="text-shadow: 2px 2px 8px #000000">Room Finder Login</h3>
            <div class="container" >
                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12" style="padding-top: 20px">
                        <form id="login-form" class="formA" method="post" action="">
                            ...
                            <div class="form-group">
                                <div class="form-group">
                                <a href="pwd_reset.php" class="text-info">Forgot your password</a><br>
